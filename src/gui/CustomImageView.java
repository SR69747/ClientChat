...
public class CustomImageView extends View {
    ...
    /**
     * Loads the image from the base64 String. This should
    ...
    private void loadImage() {
        ...
        try (ByteArrayInputStream bais = new ByteArrayInputStream(DatatypeConverter.parseBase64Binary(b64))) {
            ...
            System.out.println("Base64 image error !\n" + ex.getMessage());
        }
        image = newImage;
    }

    /**
     * Custom method for getting Base64 image String.
     *
     * @return raw Base64 image as a String
     */
